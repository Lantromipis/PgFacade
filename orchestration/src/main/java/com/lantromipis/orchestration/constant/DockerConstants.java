...
public class DockerConstants {
    ...
    public static final String HELP_CONTAINER_RESTORE_BACKUP_PATH = HELP_CONTAINER_RESTORE_ROOT_PATH + "/backup";
    public static final String HELP_CONTAINER_RESTORE_PGDATA_PATH = HELP_CONTAINER_RESTORE_ROOT_PATH + "/pgdata";
