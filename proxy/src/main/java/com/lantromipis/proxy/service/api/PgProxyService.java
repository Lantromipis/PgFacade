...
public interface PgProxyService {
     ...
     * If awaitClients is true, then method must not return until all clients are disconnected or timeout defined by awaitClientsDuration reached. After timout reached all clients must be disconnected forcibly.
