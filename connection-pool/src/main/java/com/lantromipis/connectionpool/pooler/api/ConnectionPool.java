...
public interface ConnectionPool {
     ...
     */
    void getPostgresConnection(StartupMessageInfo startupMessageInfo, boolean primary, AuthAdditionalInfo authAdditionalInfo, Consumer<PooledConnectionWrapper> readyCallback);
