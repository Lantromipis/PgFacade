...
public interface ConnectionPool {
     ...
     * @param pgAuthInfo         info about auth in case new primary connection will be created
     ...
     */
    void getPostgresConnection(StartupMessageInfo startupMessageInfo, boolean primary, PgAuthInfo pgAuthInfo, Consumer<PooledConnectionWrapper> readyCallback);
